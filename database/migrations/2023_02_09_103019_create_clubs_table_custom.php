...
class CreateClubsTableCustom extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clubs', function (Blueprint $table) {
            ...
            // DEBERIA SER NOT-NULL pero hay que revisar TextBox de Fechas
            $table->dateTime('foundation_year_month')->nullable(); // ->default(getdate());
